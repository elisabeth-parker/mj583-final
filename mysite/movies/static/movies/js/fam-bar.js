// HUGE THANK YOU TO PAUL SHERMAN FOR THIS TUTORIAL
// https://www.pshrmn.com/tutorials/d3/bar-charts/

var data = [ {"genre": "Animated", "count": 1}, {"genre": "Comedy", "count": 6}, {"genre": "Music/Performing Arts", "count": 1}, {"genre": "Documentary", "count": 1}];
...
// here, we want the full chart to be 500x200, so we determine
...
var svg = d3.select('#fam-bar-holder').append('svg')
